<div id="szv-section" style="display: none" class="container-fluid questions-wrapper">
  <div class="row">
		<div class="col-md-12">
	    <span class="question">Сдавали ли Вы форму СЗВ-М?</span><br>        
	    <label id="label-szv-quest-yes" for="szv-quest-yes">
	    	<input id="szv-quest-yes" type="radio" name="szv-quest" value="szv-quest-yes">Да
	    </label><br>
